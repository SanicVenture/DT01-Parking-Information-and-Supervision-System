# 1 "mcc_generated_files/TCPIPLibrary/log_console.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 295 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/TCPIPLibrary/log_console.c" 2
# 45 "mcc_generated_files/TCPIPLibrary/log_console.c"
...
# 46 "mcc_generated_files/TCPIPLibrary/log_console.c" 2
...
# 47 "mcc_generated_files/TCPIPLibrary/log_console.c" 2
...
# 48 "mcc_generated_files/TCPIPLibrary/log_console.c" 2
...
# 50 "mcc_generated_files/TCPIPLibrary/log_console.c" 2
...
# 51 "mcc_generated_files/TCPIPLibrary/log_console.c" 2
...
uint8_t logConsole(const char *message, uint8_t priorityVal)
{
    ...
    printf("<%d>%d %d-%.2d-%.2dT%.2d:%.2d:%.2dZ %d.%d.%d.%d %s %s %s %s[%s]\r\n", priorityVal, 1, SYSLOG_time1->tm_year, SYSLOG_time1->tm_mon, SYSLOG_time1->tm_mday, SYSLOG_time1->tm_hour, SYSLOG_time1->tm_min, SYSLOG_time1->tm_sec, ((char*)&ip)[3],((char*)&ip)[2],((char*)&ip)[1],((char*)&ip)[0], "-", "-", "-", "-", message);
    return 1;
}
